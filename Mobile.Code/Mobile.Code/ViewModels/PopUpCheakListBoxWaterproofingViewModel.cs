...
{
    public class PopUpCheakListBoxWaterproofingViewModel : BaseViewModel
    {
        ...
        private async Task done()
        {
            ...
            MessagingCenter.Send(this, "SelectedItem", CheakBoxSelectedItems);
        ...
        public PopUpCheakListBoxWaterproofingViewModel()
        {
