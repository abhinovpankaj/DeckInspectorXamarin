...
{
    public class EditProjectLocationImageViewModel : BaseViewModel
    {
        ...
        private ProjectLocation _plocation;

        public ProjectLocation ProjectLocation
        {
            get { return _plocation; }
            set { _plocation = value;OnPropertyChanged("ProjectLocation"); }
        }

        public EditProjectLocationImageViewModel()
        {
